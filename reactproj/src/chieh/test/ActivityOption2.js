                          ...
                          >
                            ...
                            <Modal.Body>
                              ...
                              <Form.Group as={Row} controlId="formPlaintextEmail">
                                <Form.Label column sm="2">活動名稱</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={item[1].activity_name} />
                                </Col>
                              </Form.Group>
                              ...
                              <Form.Group as={Row} controlId="formPlaintextPassword">
                                <Form.Label column sm="2">活動日期</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={item[1].activity_date} />
                                </Col>
                              </Form.Group> 
                              ...
                              <Form.Group as={Row} controlId="formPlaintextPassword">
                                <Form.Label column sm="2">方案</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={item[1].ticket_option} />
                                </Col>
                              </Form.Group>
                              ...
                              <Form.Group as={Row} controlId="formPlaintextPassword">
                                <Form.Label column sm="2">費用</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={item[1].ticket_price} />
                                </Col>
                              </Form.Group> 
                              ...
                              <Form.Group as={Row} controlId="formPlaintextPassword">
                                <Form.Label column sm="2">數量</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={quantity2} />
                                </Col>
                              </Form.Group>
                              ...
                              <Form.Group as={Row} controlId="formPlaintextPassword">
                                <Form.Label column sm="2">小計</Form.Label>
                                <Col sm="10">
                                  <Form.Control plaintext readOnly defaultValue={`${quantity2}`*`${item[1].ticket_price}`} />
                                </Col>
                              </Form.Group>  
                              <hr />
                              <Form.Group as={Row} controlId="formPlaintextPassword">
