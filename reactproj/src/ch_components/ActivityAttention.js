    ...
    <>
      <div className="d-flex">
        <div className="activity-info">
            <h5 className="title"><RiPushpinFill className="text-secondary"/> 為因應新型冠狀病毒，活動現場將全面升級防疫作業標準 </h5>
            <li >第一線工作人員將全面配戴口罩</li>
            <li >活動前主辦單位將確保會場桌面、麥克風、手把等均以酒精、清潔液消毒</li>
            <li >課程與會者請全程戴口罩，具有慢性病及呼吸道症狀之來賓，請務必配戴口罩參加</li>
            <li >報到前請配合量額溫、酒精消毒後方可入場 (若超過37.5度，將婉拒入場)</li>

            <h5 className="title"><RiPushpinFill className="text-secondary"/> 常見問題 </h5>
